...
class EventViewController: UIViewController {
    ...
    lazy var webView: UIWebView! = {
        ...
        webView.scrollView.contentInset = UIEdgeInsets(top: DetailViewController_TopImageView_Height - 20, left: 0, bottom: 0, right: 0)
...
extension EventViewController {
    ...
    /// 收藏
    func lickBtnClick() {
//        webView.scrollView.setContentOffset(CGPoint(x: 0, y: 5000), animated: true)
    }
